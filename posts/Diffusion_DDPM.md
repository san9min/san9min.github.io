...
**(1)Markov chain**
이 과정은 Markov chain으로 formulate할 수 있다.  
...
$q(x_{1:T})$는 q를 timestep 1부터 T까지 반복해서 노이즈를 가함을 의미하는 notation이다.
...
이를 통해 $x_t$를 $x_0$와 $\epsilon$의 함수로 볼수 있게 되어 forward process에서 $x_0$만 알면 바로  **$x_t$를 얻을 수 있게됐다.**
